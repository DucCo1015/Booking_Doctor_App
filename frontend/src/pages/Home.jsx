          ...
          <div className=' hero__content flex lg-flex-row gap-[90px] items-center justify-between'>
            ...
            <div>
              <div className='lg:w-[500px]'>
                ...
                <p className='text_para'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit explicabo maxime similique minus veniam sunt. Fugit minima illum, excepturi, id adipisci delectus error tempora beatae ex perferendis nemo rerum earum.</p>
        ...
        <div className ='container'>
          <div className='xl:w-[470px] mx-auto'>
            ...
            <p className='text__para text-center mt-4'>
              World-class care for everyone. Our healthy System offers unmatched, expect heathy care
            </p>
          </div>
          <ServicesList/>
        </div>
                ...
                <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:px-4 lg:pb-[26px] rounded-[10px]'>
                  ...
                  <div className = 'flex items-center justify-between'>
                    <div className = 'flex items-center gap-[6px] lg:gap-3'>
                      ...
                      <p className = 'text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-headingColor font-[500]'>10:00AM</p>
                    </div>
      ...
      <section>
        <div className = 'xl:w-[470px] mx-auto'>
          ...
          <p className = 'text__para text-center'>
            World-class care for everyone. Our healthy System offers unmatched, expect healthy care
          </p> 
        </div>
         ...
         <section>
          <div className="container">
            <div className="xl:w-[470px] mx-auto">
              ...
              <p className='txt__para text-center'>World-class care for everyone. Our health System offers unmatched, expert health care.</p>
            </div>
