...
const testimonialComment = [
  {
    img: patientAvatar,
    name: 'Muhibur Rahman',
    desc: 'I have medical services from them. They treat so well and they are providing the best medical services'
  },
  {
    img: patientAvatar,
    name: 'Muhibur Rahman',
...
const Testimonial = () => {
  return (
    <div className='mt-[30px] lg:mt-[55px]'>
       ...
       > 
       {
        testimonialComment.map((item,index) =>(
