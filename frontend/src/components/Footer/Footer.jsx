        ...
        <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
          <div>
            ...
            <p className="text-[16px] leading-7 font-400 text-textColor mt-4">
              Copy @ {year} developer all rights reserved.
            </p>
          ...
          <div>
            <h2 className='text-[20px] leading-[30px] font-[700] mb-6 text-textColor'>I want to:</h2>
          ...
          <div>
            <h2 className='text-[20px] leading-[30px] font-[700] mb-6 text-textColor'>Support</h2>
